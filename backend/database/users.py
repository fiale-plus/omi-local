...
if _LOCAL_MODE:
    ...
    def _normalize_platform(raw: Optional[str]):
    ...
    def add_person_speech_sample(uid: str, person_id: str, sample_path: str, transcript: Optional[str] = None, max_samples: int = 5) -> bool:
        raise NotImplementedError("cloud-only")
    ...
    def delete_user_data(uid: str):
        ...
        # Enumerate subcollections live instead of hardcoding a list
